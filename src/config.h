...
#define THING_NAME "MG_Thing"  // change this to a unique IOT device name for the MQTT Broker
#define LIGHT_SET_TOPIC "/lightSet"
#define LIGHT_LEVEL_SET_TOPIC "MG_Thing/lightSet"
#define LIGHT_LEVEL_TOPIC "/lightLevel"
#define ANNOUNCE_TOPIC "announce"
#define TEMP_SET_TOPIC "/tempSet"
#define TEMPERATURE_SET_TOPIC "MG_Thing/tempSet"
